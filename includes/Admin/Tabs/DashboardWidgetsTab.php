...
final class DashboardWidgetsTab {
	...
	public function render(): void {
		...
		// Build list of roles that have widget settings applied.
		...
		printf(
			'<select id="dac-widget-role" class="dac-select" onchange="if(this.value)window.location.href=\'%s\' + this.value">',
