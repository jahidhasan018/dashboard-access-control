...
final class ContentRestrictionsTab {
	...
	public function render(): void {
		...
		// Build list of roles that have restriction settings applied.
		...
		printf(
			'<select id="dac-restrict-role" class="dac-select" onchange="if(this.value)window.location.href=\'%s\' + this.value">',
